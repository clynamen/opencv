...
ocv_add_module(${MODULE_NAME} BINDINGS PRIVATE_REQUIRED opencv_julia_bindings_generator)


include_directories(SYSTEM
    "/home/clynamen/.julia/packages/CxxWrap/sarOk/deps/usr/include/"
    "/usr/include/julia/"
    ...
    ${CMAKE_SOURCE_DIR}/modules/flann/include
    ${CMAKE_SOURCE_DIR}/modules/gapi/include
    ${CMAKE_SOURCE_DIR}/modules/highgui/include
    ${CMAKE_SOURCE_DIR}/modules/imgcodecs/include
    ${CMAKE_SOURCE_DIR}/modules/imgproc/include
    ${CMAKE_SOURCE_DIR}/modules/ml/include
    ${CMAKE_SOURCE_DIR}/modules/photo/include
    ${CMAKE_SOURCE_DIR}/modules/stitching/include
    ${CMAKE_SOURCE_DIR}/modules/ts/include
    ${CMAKE_SOURCE_DIR}/modules/video/include
    ${CMAKE_SOURCE_DIR}/modules/videoio/include
    ${CMAKE_SOURCE_DIR}/modules/world/include
...
message("Python module the_module\n\n${the_module}\n\n")
if(TARGET gen_opencv_julia_source)
  add_dependencies(${the_module} gen_opencv_julia_source)
endif()
...
if(TARGET gen_opencv_julia_source)
  ...
  list(REMOVE_ITEM deps opencv_julia_bindings_generator) # don't add dummy module to target_link_libraries list
endif()
...
if(NOT OPENCV_SKIP_PYTHON_LOADER AND DEFINED OPENCV_PYTHON_INSTALL_PATH)
  include("${CMAKE_CURRENT_LIST_DIR}/julia_loader.cmake")
